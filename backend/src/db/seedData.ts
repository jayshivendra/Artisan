import { db, User, Product, Order, BuyerRequirement, NotificationItem } from './database.js';
...
export function initializeSeedData() {
  ...
  const sampleProducts: Product[] = [
    ...
    },
    {
      id: 'prod_005',
      seller_id: 'user_artisan_01',
      name: 'Hand-carved Sheesham Wooden Spices Box with Brass Latch',
      images: [
        'https://images.unsplash.com/photo-1590736969955-71cc94801759?w=800&auto=format&fit=crop&q=80'
      ],
      description: 'Solid seasoned Rosewood (Sheesham) 9-compartment masala organizer handcrafted by rural woodworkers. Polished with non-toxic natural beeswax.',
      description_hi: 'शीशम की लकड़ी से बना हस्तनिर्मित 9-खानो वाला मसाला बॉक्स।',
      description_regional: 'చెక్కతో చేసిన సాంప్రదాయ మసాలా డబ్బా.',
      language: 'te',
      category: 'Woodwork',
      material: 'Seasoned Indian Rosewood & Solid Brass',
      dimensions: '20cm x 20cm x 6cm',
      colour: 'Warm Natural Wood Grain',
      production_method: 'Chisel Hand-Carving & Oil Finish',
      making_time_days: 3,
      quantity: 0,
      raw_material_cost: 450,
      labour_cost: 500,
  ...
  const sampleBuyers: BuyerRequirement[] = [
    {
      id: 'req_001',
  ...
  db.buyers = sampleBuyers;
  db.notifications = sampleNotifications;
}
